        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">91% aktiv</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-orange-600">Bu həftə daxilində</p>
            </CardContent>
          </Card>
        </div>
        ...
        >
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="overview">
              {t("userManagement.tabs.overview")}
            </TabsTrigger>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          Sektor admin rolları yeniləndi
                        </p>
                        <p className="text-xs text-muted-foreground">
                          5 saat əvvəl
                        </p>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          Toplu istifadəçi ixracı aparıldı
                        </p>
                        <p className="text-xs text-muted-foreground">
                          1 gün əvvəl
                        </p>
            ...
            <Card>
              ...
              <CardContent>
                <Alert>
                  ...
                  <AlertDescription>
                    Ətraflı istifadəçi idarəetmə tablosu hazırlanır. Tezliklə
                    axtarış, filtr, redaktə və silmə funksiyaları əlavə
                    ediləcək.
                  </AlertDescription>
                </Alert>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <Alert>
                  ...
                  <AlertDescription>
                    Rol idarəetmə sistemi hazırlanır. Rol yaratma, redaktə və
                    icazə təyin etmə funksiyaları əlavə ediləcək.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <Alert>
                  ...
                  <AlertDescription>
                    İcazə idarəetmə sistemi hazırlanır. Granular icazələr və
                    rol-əsaslı giriş nəzarəti təkmilləşdirilir.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>

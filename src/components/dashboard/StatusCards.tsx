  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-2">
            {completion.completed} / {completion.total} {t('forms')}
          </p>
        </CardContent>
      </Card>
      <Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{status.approved}</div>
          <p className="text-xs text-muted-foreground mt-2">
            {t('approvedFormsDescription')}
          </p>
        </CardContent>
      </Card>
      <Card>

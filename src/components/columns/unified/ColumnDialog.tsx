...
import { Column, ColumnType, ColumnOption, ColumnFormData } from '@/types/column';
...
const COLUMN_TYPES: { value: ColumnType; label: string; description: string; supportsOptions: boolean }[] = [
  { value: 'text', label: 'Text', description: 'Single line text input', supportsOptions: false },
  { value: 'textarea', label: 'Textarea', description: 'Multi-line text input', supportsOptions: false },
  { value: 'number', label: 'Number', description: 'Numeric input', supportsOptions: false },
  { value: 'email', label: 'Email', description: 'Email address input', supportsOptions: false },
  { value: 'tel', label: 'Phone', description: 'Phone number input', supportsOptions: false },
  { value: 'url', label: 'URL', description: 'Website URL input', supportsOptions: false },
  { value: 'password', label: 'Password', description: 'Password input', supportsOptions: false },
  { value: 'date', label: 'Date', description: 'Date picker', supportsOptions: false },
  { value: 'datetime-local', label: 'DateTime', description: 'Date and time picker', supportsOptions: false },
  { value: 'time', label: 'Time', description: 'Time picker', supportsOptions: false },
  { value: 'select', label: 'Select', description: 'Dropdown selection', supportsOptions: true },
  { value: 'radio', label: 'Radio', description: 'Radio button group', supportsOptions: true },
  { value: 'checkbox', label: 'Checkbox', description: 'Single checkbox or multiple checkboxes', supportsOptions: true },
  { value: 'switch', label: 'Switch', description: 'Toggle switch', supportsOptions: false },
  { value: 'file', label: 'File', description: 'File upload', supportsOptions: false },
  { value: 'boolean', label: 'Boolean', description: 'True/false value', supportsOptions: false }
];
...
const ColumnDialog: React.FC<ColumnDialogProps> = ({
  ...
  const selectedTypeInfo = COLUMN_TYPES.find(type => type.value === formData.type);
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button type="submit" disabled={isLoading || !formData.name.trim() || !formData.category_id}>
              {isLoading ? (
                <>

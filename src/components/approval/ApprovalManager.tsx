...
import { ApprovalSubmission } from '@/types/dataEntry';

export interface ApprovalManagerProps {
  pendingApprovals?: ApprovalSubmission[];
  approvedItems?: ApprovalSubmission[];
  rejectedItems?: ApprovalSubmission[];
  isLoading?: boolean;
...
const ApprovalManager: React.FC<ApprovalManagerProps> = ({
  ...
  const renderApprovalItem = (item: ApprovalSubmission) => (
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-semibold">Təsdiq Meneceri</h2>

    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            {isUploading && (
              <>
                ...
                <div>
                  <p className="font-medium">{t('uploading')}: {fileName}</p>
        ...
        <div className="text-sm text-muted-foreground space-y-1">
          <p>• {t('uploadInstructions1') || 'First row should contain column headers'}</p>
          <p>• {t('uploadInstructions2') || 'Data should start from second row'}</p>
